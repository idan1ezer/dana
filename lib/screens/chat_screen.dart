    ...
    return Padding(
      ...
      child: ListView(
        children: const [
          ...
          _MessageTile(
              message: "Hi Dana, how are you?", messageDate: "12:00 PM"),
          _MessageOwnTile(
              message: "Im fine, thank you!", messageDate: "12:01 PM"),
          _MessageTile(message: "What are you doing?", messageDate: "12:05"),
          _MessageOwnTile(
              message: "Developing DANA chatbot", messageDate: "12:07"),
          _MessageOwnTile(
              message: "This might be ready soon :)", messageDate: "12:07"),
        ],
      ),
    );
  }
    ...
    return SafeArea(
      ...
      child: Row(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 12.0, right: 24.0, bottom: 8.0),
